    ...
    public partial class initalcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Maximilian", "Vollendorf" },
                    { 2, "Frank", "Bongers" },
                    { 3, "Michael", "Wegelin" },
                    { 4, "Michael", "Englbrecht" },
                    { 5, "Adam", "Freeman" },
                    { 6, "Ugurlu", "Tugberk" },
                    { 7, "Alexander", "Zeitler" },
                    { 8, "Ali", "Kheyrollahi" }
            ...
            migrationBuilder.InsertData(
                table: "Book",
                columns: new[] { "Id", "Location", "PublisherId", "Title" },
                values: new object[,]
                {
                    { 1, "Büro 34", null, "jQuery - Das umfassende Handbuch" },
                    { 2, "Büro 34", null, "SAP® - Schnittstellenprogrammierung" },
                    { 3, "Büro 34", null, "Pro ASP.NET MVC 4" },
                    { 4, "Büro 34", null, "Pro ASP.NET Web API" }
                });
